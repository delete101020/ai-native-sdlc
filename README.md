...
```sh
pnpm install
pnpm package:extension                                  # → packages/extension/aidlc-native-4.0.23.vsix
code --install-extension packages/extension/aidlc-native-4.0.23.vsix
```
