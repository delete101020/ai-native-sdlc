...
<ul>
  <li><code>pnpm --filter aidlc-native bundle:webviews</code> — one-shot Vite build</li>
  <li><code>pnpm --filter aidlc-native watch</code> — tsc + Vite watch in parallel (recommended for dev)</li>
</ul>
