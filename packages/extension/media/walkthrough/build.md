...
|---|---|---|
| **Skill** | A markdown prompt that defines *how* an agent does a task | `AIDLC Native: Add Skill` — template / paste / upload / blank |
| **Agent** | A skill bound to a model (Sonnet / Opus / Haiku) | `AIDLC Native: Add Agent` |
| **Pipeline** | An ordered chain of agents with on-failure behavior | `AIDLC Native: Add Pipeline` |
...
> Built-in presets ship with the extension — try `AIDLC Native: Load Template` to see them.
